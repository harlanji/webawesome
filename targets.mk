...
$(CLIENT_JS:.js=.js.map): $(CLIENT_JS)
	touch $@ # this is generated by tsc in the CLIENT_JS step.
...
$(ALL_JS:.js=.js.map): $(ALL_JS) $(CLIENT_JS:.js=.js.map)
	touch $@
...
dist/public/css/%.css: src/client/%.scss
	node-sass $< $@
